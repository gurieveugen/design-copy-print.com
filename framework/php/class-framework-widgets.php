	...
	class avia_google_maps extends WP_Widget {
		...
		function form($instance) {
			...
			?>
				...
				<p>
				Enter the latitude and longitude of the location you want to display. You can <a target='_blank' href='http://itouchmap.com/latlong.html'>fetch them here</a><br/><br/><!-- http://www.getlatlon.com/ -->
				...
				<p>
				<label for="<?php print $this->get_field_id('directionsto'); ?>"><?php _e('Display a Route by entering a address here. (If address is added Zoom will be ignored)'); ?></label>
